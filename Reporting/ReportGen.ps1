...
# this helps load the last run state for comparison 
...
# saves the report from the last run state
...
# calaculates the drift trend 
# Dependes on having a saved Drift state
